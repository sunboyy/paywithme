...
// The wrapped twin of the bare code/symbol `toMcpMoney` inlines — shared with the
// record-later view since #52, so both surfaces attribute a member-defined currency
// identically (ADR-0003). See `custom-currency.ts`.
